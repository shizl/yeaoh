<div id="page_wrapper"><!-- start page_wrapper -->
  <div id="center"><!-- start cneter -->
	   ...
	   <!-- start centermain -->
			   ...
			   <?php if($page['main_column']): ?>
			     <div class="main_column"><?php print render($page['main_column']) ;?></div>
			   <?php endif ; ?> 
                        <div id="main_content">
...
jQuery("#block-locale-language .content").append('<div id="language_arrow"><a><img src="http://dev.yeaoh.com/sites/all/themes/yeaoh_website/images/flag_english.png"/><span>English</span></a></div>');
