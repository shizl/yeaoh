...
class Gardener {
  ...
  public function prune() {
    ...
    if (!$destination->op('delete')) {
  		throw new ErrorException('This destination cannot be prunned because deleting is not supported', 'error');
  	}
